...
export default function MobileLayout({
  ...
  return (
    <div className={`flex flex-col h-screen bg-gray-50 ${className}`}>
      {/* Header */}
      <header className="bg-white shadow-sm border-b border-gray-200 p-4 min-h-[60px]">
        <div className="flex items-center justify-between">
          <h1 className="text-xl font-semibold text-gray-900">
            A Digital Moving Mountain
          </h1>
          <button className="p-3 rounded-full hover:bg-gray-100 min-h-[44px] min-w-[44px] flex items-center justify-center touch-manipulation">
      ...
      {/* Footer */}
      <footer className="bg-white border-t border-gray-200 p-4 text-center min-h-[60px] flex items-center justify-center">
